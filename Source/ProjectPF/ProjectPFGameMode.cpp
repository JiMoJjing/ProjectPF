...
AProjectPFGameMode::AProjectPFGameMode()
{
	...
	//static ConstructorHelpers::FClassFinder<APawn> PlayerPawnBPClass(TEXT("Blueprint'/Game/ProjectPF/Characters/BP_CPlayableCharacterBase.BP_CPlayableCharacterBase'"));
